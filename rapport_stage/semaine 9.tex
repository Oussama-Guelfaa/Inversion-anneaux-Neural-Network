...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Stage/plots/sim_vs_exp_profiles.png}
...
Avant de présenter mon modèle final, je dois expliquer ce qu'est un réseau de neurones.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Stage/plots/domain_adaptive_results_fixed.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Stage/plots/detailed_experimental_vs_simulation_comparison.png}
